...
(function (root) {
  ...
  lib.define((k) => {
    ...
    return {
      id: 'calfstretch', order: 50, vetted: true, tracking: 'form', camera: { height: 'hip', distance: '2–3 m', posture: 'standing' }, sided: { limb: 'leg', by: 'camera' }, name: 'Wall calf stretch', group: 'Foot & ankle', type: 'hold', view: 'side', icon: '🧗',
