...
(function (root) {
  ...
  lib.define((k) => {
    ...
    return {
      id: 'hipabd', order: 20, vetted: true, tracking: 'form', camera: { height: 'hip', distance: '2.5 m', posture: 'standing' }, sided: { limb: 'leg', by: 'pick' }, name: 'Standing hip abduction', group: 'Hip strength', type: 'reps', view: 'front', icon: '🧍',
