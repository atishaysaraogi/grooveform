...
(function (root) {
  ...
  lib.define((k) => {
    ...
    return {
      id: 'shoulder_er', order: 60, vetted: true, tracking: 'form', camera: { height: 'chest', distance: '2 m', posture: 'standing' }, sided: { limb: 'arm', by: 'pick' }, upperBody: true, name: 'Standing shoulder rotation (band)', group: 'Shoulder — rotator cuff', type: 'reps', view: 'front', icon: '💪',
