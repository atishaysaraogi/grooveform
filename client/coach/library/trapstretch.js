...
(function (root) {
  ...
  lib.define((k) => {
    ...
    return {
      id: 'trapstretch', order: 100, vetted: true, tracking: 'form', camera: { height: 'chest', distance: '1.5 m', posture: 'sitting' }, sided: { limb: 'side', by: 'pick' }, upperBody: true, name: 'Upper trapezius stretch', group: 'Neck', type: 'hold', view: 'front', icon: '🧘',
