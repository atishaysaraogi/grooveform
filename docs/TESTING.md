...
53. Start a bridge and spend several seconds shuffling into position with the heels well out from the hips: nothing about the start position is named or spoken while you are moving, and the overlay says it is waiting. Settle correctly and the count-in starts; the set has no set-up fault against it. Settle with the heels still out and it is named, once you have stopped.
54. Sit up with the knees hugged, still, on a bridge: the count-in does not start and the overlay says to lie back. Lie back and it starts. Then, lying still, nothing is said until you begin the first rep. Lift a heel at the top of a rep, and on another rep lift the toes: both are named “foot coming off the floor” — side-on the camera cannot tell them apart.
